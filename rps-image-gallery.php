	...
	public function cb_gallery_shortcode( $atts, $content = null ) {
		...
		foreach ( $attachments as $attachment ) {
			...
			if ( $str_caption != '' ) :
				/**
				 * @since version 1.2.5
				 * strip tags from the caption if it is to be used as the title value since markup not allowed
				 */
			...
			/**
			 * @since version 1.2.2
			 * if slideshow is set to false and link is set to 'none' then omit the hyperlink and just display the image
			 */
			if ( !$slideshow && $link == 'none' ) :
