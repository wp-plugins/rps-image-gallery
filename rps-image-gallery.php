...
class RPS_Image_Gallery {
	...
	public function __construct() {
		...
		add_action( 'edit_form_after_editor', array( &$this, 'remove_edit_form_image_editor' ), 99 );
		...
		add_action( 'edit_form_after_title', array( &$this, 'custom_edit_form_image_editor' ), 10 );
		
		add_action( 'edit_form_after_editor', array( &$this, 'close_custom_edit_form_image_editor' ), 10 );
	}
	
	function remove_edit_form_image_editor(){
		remove_action('edit_form_after_title', 'edit_form_image_editor', 99 );
	}
	

	/*
	 * Add the TibyMCE toolbar to caption field to the page for editing.
	 *
	 * @since version 1.2.15
	 */
	
	function custom_edit_form_image_editor(  ) {
		$post = get_post();
		...
		<div class="wp_attachment_details">
			<p>
				...
				<?php wp_editor( $post->post_excerpt, 'attachment_caption', $editor_args ); ?>
<!-- 				<textarea class="widefat" name="excerpt" id="attachment_caption"><?php echo $post->post_excerpt; ?></textarea> -->
	...
	function close_custom_edit_form_image_editor(){
		echo '-->';
	}
