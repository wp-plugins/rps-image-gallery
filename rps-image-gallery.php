...
class RPS_Image_Gallery {
	...
	public function cb_init() {
		...
		wp_register_script( 'rps-image-gallery-jquery', '//ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js', false, '1.8.3', true );
		wp_register_script( 'rps-image-gallery-easing', plugins_url( 'dependencies/fancybox/jquery.easing-1.3.pack.2.js', __FILE__ ), array( 'rps-image-gallery-jquery' ), '1.3', true );
